...
public class ControladorPagina {
	...
	public String inicio(Model model, HttpServletRequest req) {
		if (req.getUserPrincipal() != null) {
			...
			model.addAttribute("nombreuser", "INVITADO");
	...
	public String registrado(Model model, User usuario) {
		if (userRepository.getByNombre(usuario.getNombre()) != null)
			return "userexists";
	...
	public String postCreate(Model model, @RequestParam String titulo, @RequestParam String contenido,
